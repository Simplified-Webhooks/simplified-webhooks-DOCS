...
Create a new scenario, search for 'Simplified Webhooks' and choose the `Watch Updated Airtable Records` module. If you have not setup a module before, visit the [quickstart](https://simplified-webhooks.com/docs/quickstart) to go through every step.
